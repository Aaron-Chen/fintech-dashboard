...
import { MdCalendarToday, MdTrendingUp, MdAccountBalance, MdBarChart, MdSearch, MdArrowOutward, MdAccountBalanceWallet, MdArrowBack, MdMenuBook } from "react-icons/md";
  ...
  return (
    <div className="text-white w-full relative">
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-full px-8 relative">
          {/* Connect view */}
          <div className={`absolute inset-0 flex flex-col items-center justify-center transition-opacity duration-700 ease-in-out ${showExplanation ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
            <h2 
              className="text-white text-4xl font-medium mb-8 text-center" 
              style={{ fontFamily: 'Jura, sans-serif' }}
            >
          ...
          <div className={`absolute inset-0 flex flex-col items-center justify-center transition-opacity duration-700 ease-in-out ${!showExplanation ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
            ...
            <button
              ...
              className="absolute top-12 left-8 flex items-center gap-2 text-white/60 hover:text-white transition pointer-events-auto"
              style={{ fontFamily: 'Jura, sans-serif' }}
            >
              <MdArrowBack size={48} />
            ...
            <div className="flex flex-col items-center">
              <div className="max-w-2xl text-center space-y-4 mb-0">
                <p 
